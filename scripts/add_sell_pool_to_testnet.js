...
const exec = async(callback) => {
  ...
  const sellPools = [{
    ...
    startTime: parseInt((new Date("2021-04-02 06:00:00 UTC")).getTime()/1000),
    ...
    startTime: parseInt((new Date("2021-04-06 06:00:00 UTC")).getTime()/1000),
    endTime: parseInt((new Date("2021-04-10 06:00:00 UTC")).getTime()/1000),
    allocationMin: toWei('0.1', 'ether'),
    allocationMax: toWei('5', 'ether'),
    marketPoint: 5,
    devPoint: 10,
    isPrivate: true,
      ...
      startTime: parseInt((new Date("2021-04-02 06:00:00 UTC")).getTime()/1000),
      endTime: parseInt((new Date("2021-04-11 06:00:00 UTC")).getTime()/1000),
      allocationMin: toWei('0.1', 'ether'),
      allocationMax: toWei('5', 'ether'),
      marketPoint: 5,
      devPoint: 10,
